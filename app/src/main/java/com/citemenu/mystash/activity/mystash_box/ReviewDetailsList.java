...
import com.citemenu.mystash.pojo.pojo_searchbusiness.Review;
...
public class ReviewDetailsList extends AppCompatActivity {
    ...
    private com.citemenu.mystash.pojo.pojo_searchbusiness.Searchnearby jsonObject;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jsonObject = new Gson().fromJson(s, com.citemenu.mystash.pojo.pojo_searchbusiness.Searchnearby.class);
