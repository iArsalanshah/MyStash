...
public class Register extends AppCompatActivity implements AdapterView.OnItemSelectedListener, com.citemenu.mystash.login_pages.MultiSpinner.MultiSpinnerListener {
    ...
    private com.citemenu.mystash.login_pages.MultiSpinner multiSpinnerCat;
    private ArrayList<String> listCat, listInterest;
    private com.citemenu.mystash.login_pages.MultiSpinner multiSpinnerInterest;
...
//        Log.d(com.citemenu.mystash.helper.Constant_util.LOG_TAG, "onCreate: " + gcmID);
    ...
    private void initialization() {
        ...
        //Spinner
        multiSpinnerCat = (com.citemenu.mystash.login_pages.MultiSpinner) findViewById(R.id.multi_spinnerCat);
        multiSpinnerInterest = (com.citemenu.mystash.login_pages.MultiSpinner) findViewById(R.id.multi_spinnerInterest);
    ...
    private void settingAdapter() {
        ...
        com.citemenu.mystash.login_pages.MultiSpinner.MultiSpinnerListener listener = new com.citemenu.mystash.login_pages.MultiSpinner.MultiSpinnerListener() {
            @Override
...
//                        Log.d(com.citemenu.mystash.helper.Constant_util.LOG_TAG, "Upload Profile Image onResponse: " + uploadImage + uploadImage.getHeader().getMessage());
                    }
                }
