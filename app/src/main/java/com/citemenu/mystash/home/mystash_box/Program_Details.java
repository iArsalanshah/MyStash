...
//                startActivity(sendIntent);
    ...
    private void updateStamps() {
        dialogP.show();
        Call<com.citemenu.mystash.pojo.stampCount.StampCountWebService> call = WebServicesFactory.getInstance().getStampCount(com.citemenu.mystash.helper.Constant_util.ACTION_GET_STAMPS_COUNT, cid, stampObject.getPid());
