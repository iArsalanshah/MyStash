...
public class ListDetails_MyStash extends AppCompatActivity {
    ViewPager viewPager;
    com.citemenu.mystash.home.mystash_box.viewpager_adapter.ViewPagerAdapter adapter;
    ...
    private String s;
    private com.citemenu.mystash.pojo.pojo_searchbusiness.Searchnearby gsonBusiness;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        users_obj = com.citemenu.mystash.webservicefactory.CustomSharedPref.getUserObject(ListDetails_MyStash.this);
...
//            Log.d(com.citemenu.mystash.helper.Constant_util.LOG_TAG, "Could not parse malformed JSON: \"" + s + "\"");
        ...
        gsonBusiness = new Gson().fromJson(s, com.citemenu.mystash.pojo.pojo_searchbusiness.Searchnearby.class);
        ...
        adapter = new com.citemenu.mystash.home.mystash_box.viewpager_adapter.ViewPagerAdapter(this, gsonBusiness);
    ...
    private void clickEvents(final com.citemenu.mystash.pojo.pojo_searchbusiness.Searchnearby searchnearby) {
        imgPrograms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ListDetails_MyStash.this, com.citemenu.mystash.home.mystash_box.ProgramsList.class);
        ...
        imgCoupons.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ListDetails_MyStash.this, com.citemenu.mystash.home.coupons_box.Coupons_Categories_Click.class);
        ...
        imgWrite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent writeIntent = new Intent(ListDetails_MyStash.this, com.citemenu.mystash.home.mystash_box.RateAndReview.class);
    ...
    public void removeStash(com.citemenu.mystash.pojo.pojo_searchbusiness.Searchnearby searchnearby) {
        Call<com.citemenu.mystash.pojo.remove_stash.RemoveStash> call = WebServicesFactory.getInstance().getRemoveStash(com.citemenu.mystash.helper.Constant_util.ACTION_REMOVE_STASH, searchnearby.getId(), users_obj.getId());
        call.enqueue(new Callback<com.citemenu.mystash.pojo.remove_stash.RemoveStash>() {
            ...
            public void onResponse(Call<com.citemenu.mystash.pojo.remove_stash.RemoveStash> call, Response<com.citemenu.mystash.pojo.remove_stash.RemoveStash> response) {
                com.citemenu.mystash.pojo.remove_stash.RemoveStash stash = response.body();
                if (stash == null) {
    ...
    public void addStash(com.citemenu.mystash.pojo.pojo_searchbusiness.Searchnearby searchnearby) {
        Call<com.citemenu.mystash.pojo.add_stash.AddStash> call = WebServicesFactory.getInstance().getAddStash(com.citemenu.mystash.helper.Constant_util.ACTION_ADD_STASH, searchnearby.getId(), users_obj.getId());
    ...
    private void settingData(com.citemenu.mystash.pojo.pojo_searchbusiness.Searchnearby searchnearby) {
...
//        tvDesc.setText("" + searchnearby.getReviews());
    ...
    private void swappingStashImg(com.citemenu.mystash.pojo.pojo_searchbusiness.Searchnearby searchnearby) {
    ...
    public void textViewReviews(View view) {
        ...
        int size = gsonBusiness.getReviews().size();
        if (obj.has("reviews") && size != 0) {
            Intent intent = new Intent(this, com.citemenu.mystash.home.mystash_box.ReviewDetailsList.class);
    ...
    public void onClickMapIcon(View view) {
        Intent intent = new Intent(this, com.citemenu.mystash.home.businessMapActivity.class);
