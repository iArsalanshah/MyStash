...
public class CropOverlayView extends View implements IGetImageBounds {
    ...
    private static final int DEFAULT_OVERLAY_COLOR = Color.argb(200, 0, 0, 0);
    //Defaults
    ...
    private int DEFAULT_CROPWIDTH = 250;
    private int DEFAULT_CROPHEIGHT = 145;
    ...
    private float cropHeight = DEFAULT_CROPHEIGHT; //todo need to make rect here
...
//            drawRuleOfThirdsGuidelines(canvas);
    ...
    private void init(Context context) {
        ...
        cropHeight = (float) (cropWidth * 0.57);
        int edgeT = mMarginTop;
        float edgeB = mMarginTop + cropHeight;
